...
//
//   J and L keys to roll,      //회전
//   I and K keys to pitch,     //위아래
//   H and ; keys to yaw,       //좌우
//   8 key to increase speed and the M key to decrease speed.   //속도 조절
//   W key toggles wireframe mode         //풍경 표기방식
//   R key generates a new landscape      //새로운 풍경
//
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Flight Simulator 201713922 이건회");
